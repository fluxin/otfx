...
<img src="docs/images/decrypt.gif" width="588" alt="otfx decrypt preview">

The animation above is generated by `otfx`'s own effect and terminal-cell
renderer. It uses the current Omarchy Tokyo Night palette and JetBrains Mono
9-point cell geometry. `otfx` follows the same effect vocabulary and CLI shape
as Rust `ttfx`, but it is a native Odin implementation with a deliberately
different renderer and direct state machines. It does not claim byte-for-byte
terminal-stream parity.
...
Reference animations for the corresponding ttfx effects are available in the
[upstream ttfx effect gallery](https://github.com/omacom-io/ttfx/tree/adcdae9f17b84b795ca050ab6f6dc68cca1cc699/docs/effects).
They document the reference art direction, not byte-identical otfx output.

<img src="docs/images/fireworks.gif" width="390" alt="otfx fireworks preview">
<img src="docs/images/blackhole.gif" width="390" alt="otfx blackhole preview">
